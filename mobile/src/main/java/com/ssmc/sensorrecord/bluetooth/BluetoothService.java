...
import com.ssmc.sensorrecord.mobileUI.DeviceListActivity;
import com.ssmc.sensorrecord.mobileUI.MobileActivity;
...
public class BluetoothService extends Service {
     ...
     */
    public BluetoothService(Context context, Handler handler,int count) {
    ...
    public void onClickBuletoothButton() {
        Intent deviceListIntent = new Intent(mActivity, DeviceListActivity.class);
        mActivity.startActivityForResult(deviceListIntent, REQUEST_CONNECT_DEVICE_SECURE);
    }
     ...
     */
    public synchronized void connect(BluetoothDevice device, boolean secure,int count) {
