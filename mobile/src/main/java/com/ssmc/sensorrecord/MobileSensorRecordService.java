...
public class MobileSensorRecordService extends Service {
    ...
    public static SensorDataWriter mSensorDataWriter1;
    public static SensorDataWriter mSensorDataWriter2;
...
//
    ...
    public class MySensorEventListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            try {
                mSensorDataWriter1.writeSensorData(sensorRecord);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public static void writeWearData(SensorRecord sensorRecord,int count){
        try {
            if(count==0)
                mSensorDataWriter1.writeSensorData(sensorRecord);
            else if(count==1)
                mSensorDataWriter2.writeSensorData(sensorRecord);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public class SensorRecordBinder extends Binder {
        ...
        public void stop() {
            ...
            try {
                ...
                mSensorDataWriter1.close();
                mSensorDataWriter2.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
